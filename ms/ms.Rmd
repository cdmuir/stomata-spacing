...
We developed a dispersion index $\mathrm{DI}$ to quantify how close observed stomatal distributions are to random uniform versus ideally dispered in an equilateral triangular grid. $\mathrm{DI}$ varies from zero to one, where zero is uniformly random and one is ideally dispersed:
